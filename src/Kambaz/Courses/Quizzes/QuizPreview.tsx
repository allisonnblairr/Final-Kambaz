  ...
  const saveQuizAttempt = async () => {
    ...
    for (const [questionId, answer] of Object.entries(userAnswers)) {
      ...
      const newGivenAnswer = {
        _id: uuidv4(),
        answerContent: isText ? answer : possibleAnswers.find(a => a._id === answer)?.answerContent,
        questionId,
      };
  
      const savedAnswer = await questionsClient.createGivenAnswerForQuestion(questionId, newGivenAnswer);
